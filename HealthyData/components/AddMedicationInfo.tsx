...
const AddMedicationInfo = ({navigation, route}: Props): JSX.Element => {
  ...
  const addTodo = () => {
    ...
    if (!isInterval) {
      ...
      refillDate = addDays(
        parseInt(intervalDays) * parseInt(supply),
        startDate,
      );
    }
    ...
    <View style={styles.addMedicationContainer}>
      <ScrollView>
        ...
        <Text style={styles.addMedicationTitle}>
          Do you take {genericName} on the same days every week?
        </Text>
        <View style={styles.radioButtonsContainer}>
          <RadioButton
            ...
            selected={!isInterval}
            selectedStyle={[
              styles.toggleIntervalButton,
              styles.buttonSelectedColor,
            ]}
            unselectedStyle={[
              styles.toggleIntervalButton,
              styles.buttonUnselectedColor,
            ]}
            onPress={() => {
              setIsInterval(false);
            }}
        ...
        {!isInterval && (
          <>
            <Text style={styles.addMedicationTitle}>
              On which days are you to take {genericName}?
            </Text>
            <View style={styles.radioButtonsContainer}>
              <RadioButton
                text="M"
        ...
        {isInterval && (
          <>
            ...
            <View style={styles.row}>
              <Text style={styles.addMedicationTitle}>Once every</Text>
              <TextInput
              ...
              />
              <Text style={styles.addMedicationTitle}>days</Text>
            </View>

            <Text style={styles.addMedicationTitle}>
              When will you start taking {genericName}?
            </Text>
        ...
        <Text style={styles.addMedicationTitle}>
          What time of day are you to take {genericName}?
        </Text>
        ...
        <Text style={styles.addMedicationTitle}>
          When will you stop taking {genericName}?
        </Text>
        ...
        <Text style={styles.addMedicationTitle}>
          How many doses of {genericName} will you take?
        </Text>
        ...
        <Text style={styles.addMedicationTitle}>
          What is your current supply of {genericName}?
        </Text>
      ...
      <View style={styles.infoButton}>
        <Button
          ...
          disabled={
            doses === '' || supply === '' || (isInterval && intervalDays === '')
          }
          onPress={() => {
            addTodo();
